...
pub fn build_node(
    ...
    // persisted ledger tip. Realign makes the best-chain pointer match. World tests keep the
    // persisted best chain so already-validated blocks stay on the advertised tip.
